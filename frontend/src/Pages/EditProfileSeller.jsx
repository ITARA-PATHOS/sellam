    ...
    <div className="cart-container5">
      ...
      <div className="chat-ap">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="editprof-info-card">
            <div style={{ flex:1 }}>
              <p style={{ marginBottom:'5px' }}><strong>Bank Details:</strong> {formData.bank_details || 'Not Provided'}</p>
              {bankEdit && (
                <div className="bank-edit-container">
                  <input type="text" className="editprof-input-code-box" value={bankInput} onChange={e => setBankInput(e.target.value)}/>
                  <button type="button" className="editprof-submit-verify-btn" onClick={handleBankEditSubmit}>Save</button>
                </div>
              )}
            </div>
